...
export async function generateMetadata({ params }) {
  ...
  return {
    title: {
      fr: "Massage relaxant à Hal · détente totale",
      en: "Relaxing Massage in Halle – 60 min from €120",
      nl: "Ontspanningsmassage Halle – 60 min vanaf 120€",
    }[currentLocale],
    description: {
      fr: "Massage relaxant à Halle pour relâcher les tensions et retrouver un calme profond. 60 min de détente, praticien certifié, dès 120€. Réservez en ligne.",
