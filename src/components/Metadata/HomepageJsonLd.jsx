  ...
  const faqByLocale = {
    fr: [
      ...
      { q: "Quels sont les tarifs ?",
        a: "Les séances en cabinet démarrent à 80 € (60 min). Les massages plus longs (90 min) et les déplacements à domicile à Bruxelles, Uccle, Waterloo ou Braine-l'Alleud sont proposés sur devis selon la zone." },
    ...
    en: [
      ...
      { q: "What are the prices?",
        a: "In-studio sessions start at €80 (60 min). Longer massages (90 min) and at-home visits to Brussels, Uccle, Waterloo or Braine-l'Alleud are quoted depending on the area." },
    ...
    nl: [
      ...
      { q: "Wat zijn de tarieven?",
        a: "Sessies in de praktijk starten vanaf 80 € (60 min). Langere massages (90 min) en huisbezoeken in Brussel, Ukkel, Waterloo of Eigenbrakel worden op offerte berekend afhankelijk van de zone." },
