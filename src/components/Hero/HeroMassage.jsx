...
export default function HeroMassage({ variant, waMessage }) {
  ...
  const defaultWaMessage = {
    fr: `Bonjour, j'aimerais réserver une séance de ${t("title")}. Quelles sont vos disponibilités ?`,
    en: `Hello, I would like to book a ${t("title")} session. What is your availability?`,
    nl: `Hallo, ik wil graag een ${t("title")} sessie boeken. Wat is uw beschikbaarheid?`,
  };
  const waText = waMessage || defaultWaMessage[locale] || defaultWaMessage.fr;
  const waUrl = `https://wa.me/32477131993?text=${encodeURIComponent(waText)}`;
      ...
      <div className="relative z-10 flex flex-col justify-center min-h-[60vh] lg:min-h-[70vh] px-6 py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 flex justify-center animate-fade-up" style={{ animationDelay: "0.3s" }}>
            <a href={waUrl} target="_blank" rel="nofollow noopener noreferrer" className="btn-whatsapp">
