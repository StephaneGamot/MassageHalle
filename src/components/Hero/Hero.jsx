        ...
        <div className="overflow-hidden">
          <div className="mx-auto max-w-7xl py-6 px-6 lg:py-16 lg:px-8">
            ...
            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              ...
              target="_blank"
              rel="noreferrer"
                    className="rounded-md bg-[#1EBE5D] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#8FBC8F] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#556B2F]"
                  >
                     WhatsApp
            </a>
                  <Link
