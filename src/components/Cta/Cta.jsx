        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
          ...
          <div className="max-w-xl">
            ...
            <div className="mt-8 flex justify-center">
              ...
              target="_blank"
              rel="noreferrer"
                    className="rounded-md bg-[#1EBE5D] px-7.5 py-2.5  text-sm font-semibold text-white shadow-sm hover:bg-[#8FBC8F] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#556B2F]"
                  >
                     WhatsApp
            </a>
            </div>
